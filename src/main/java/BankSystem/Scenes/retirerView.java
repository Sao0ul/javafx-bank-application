...
public class retirerView extends StackPane {

    public retirerView(Stage primaryStage) {
        this();
    ...
    public retirerView() {
        ...
        ValiderButton.addEventHandler(ActionEvent.ACTION, e -> {
            ...
            try {
                ...
                dataBaseManager.debit(nameAccount, passwordAccount, montant);
                ...
                managerView.setActualScene(new retirerView());
                // afficharge de la vue des erreurs
                managerView.showView(ValiderButton, new errorView("Donnée invalide"));
            }
        });
